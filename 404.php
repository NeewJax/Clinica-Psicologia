    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h1 class="m-0 text-primary">
                ...
                <img id="estacio" src="img/logo-estacio.png" alt="">
            </h1>
        </a>
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <p class="mb-4">Desculpe, mas a página que você procurou não existe em nosso site!</p>
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="index.php">Voltar para página inicial</a>
                </div>
            </div>
        </div>
    </div>
