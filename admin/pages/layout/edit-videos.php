...
<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $stmt->bind_param("sssi", $titulo, $descricao, $replace, $id);

        if ($stmt->execute()) {
            $stmt->close();
            $mysqli->close();
            header("Location: videos.php?msg=Atualização realizada com sucesso");
            exit;
        } else {
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Editar vídeos</li>
          </ol>
        </section>
...
<div class="container-fluid">
              ...
              <input type="text" class="form-control custom-input custom-input" name="link" value="<?php echo $row['link']; ?>">
