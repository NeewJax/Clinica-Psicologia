            ...
            <div>
              ...
              <table class="table table-hover text-center">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM tbl_professor $where ORDER BY id DESC LIMIT 8";
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="font-weight:bold;font-size:140%;">DELETAR PROFESSOR</h5>
  ...
  <script>
    ...
    buttons.forEach(button => {
      button.addEventListener('click', function() {
        ...
        modalLink.href = "delete/delete-professor.php?id=" + id;
