<?php
  ...
  if (isset($_POST['enviar'])) {
    ...
    try {
        ...
        // INSERIR PACIENTE
        $stmt_id_paciente = $mysqli->prepare("INSERT INTO tbl_paciente (id, nome, nascimento, rg, cpf, id_genero, id_contato, id_escolaridade, id_profissao, id_renda_familiar, id_estado_civil, id_endereco, id_maturidade) 
        VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt_id_paciente->bind_param("ssiiiiiiiiii", $nome, $nascimento, $rg, $cpf, $id_genero, $id_contato, $id_escolaridade, $id_profissao, $id_renda_familiar, $id_estado_civil, $id_endereco, $id_maturidade);
